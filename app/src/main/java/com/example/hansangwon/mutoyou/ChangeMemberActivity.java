...
public class ChangeMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rewrite);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(nowpassword.getText().toString().isEmpty())  CreateAlertDialog("현재 비밀번호를 입력해주세요.");
                else{
                    if(newpassword.getText().toString().isEmpty())  CreateAlertDialog("새로운 비밀번호를 입력해주세요.");
                    else{
                        if(newpassword.getText().length()>20||newpassword.getText().length()<4) CreateAlertDialog("4~20자리의 비밀번호를 입력해주세요.");
                        else {
    ...
    private void getinf(final String id){
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ChangeMemberActivity.this, "Please Wait", null, true, true);
        ...
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.contains("success")){
                    AlertDialog.Builder alert= new AlertDialog.Builder(ChangeMemberActivity.this);
                    alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent intent=new Intent(ChangeMemberActivity.this, MainActivity.class);
